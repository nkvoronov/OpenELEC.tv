...
make_target() {
  ...
  mkdir -p $SYSROOT_PREFIX/usr/lib
    ...
    cp -PR $ROOT/$PKG_BUILD/libskindesignerapi/libskindesignerapi.so.0.1.0 $SYSROOT_PREFIX/usr/lib
    ln -s libskindesignerapi.so.0.1.0 $SYSROOT_PREFIX/usr/lib/libskindesignerapi.so.0
    ln -s libskindesignerapi.so.0.1.0 $SYSROOT_PREFIX/usr/lib/libskindesignerapi.so
