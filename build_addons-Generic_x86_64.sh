...
#PROJECT=Generic ARCH=x86_64 ./scripts/create_addon mksquashfs
#PROJECT=Generic ARCH=x86_64 ./scripts/create_addon scan-s2a
#PROJECT=Generic ARCH=x86_64 ./scripts/create_addon szap-s2a
PROJECT=Generic ARCH=x86_64 ./scripts/create_addon tbscc-install
#PROJECT=Generic ARCH=x86_64 ./scripts/create_addon eventlircd-fix-install
#PROJECT=Generic ARCH=x86_64 ./scripts/create_addon lcdproc-fix-install